 ...
 ********************************************************************/
    ...
    /* STD_ID */
    CAN_0.BUF[0].ID.B.STD_ID = 0x101; /* light sensor message id */
    ...
    /* STD_ID */
    CAN_0.BUF[1].ID.B.STD_ID = 0x102; /* doors sensor message id */
    ...
    /* STD_ID */
    CAN_0.BUF[2].ID.B.STD_ID = 0x103; /* fuel level warning message id */
    ...
    /* Data Length */
    CAN_0.BUF[3].CS.B.LENGTH = 1;
    /* STD_ID */
    CAN_0.BUF[3].ID.B.STD_ID = 0x104; /* engine cooling warning message id*/
    ...
    /* STD_ID */
    CAN_0.BUF[4].ID.B.STD_ID = 0x105; /* alive signal message id */
    ...
    /* Data Length */
    CAN_0.BUF[5].CS.B.LENGTH = 0;
    /* STD_ID */
    CAN_0.BUF[5].ID.B.STD_ID = 0x106; /* error signal message id */
